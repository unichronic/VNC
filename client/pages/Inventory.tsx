      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Manage VNC targets and credentials (secrets stored in vault —
            simulated).
          </p>
        </div>
            ...
            <TableBody>
              {entries.map((e) => (
                <TableRow key={e.id}>
                  ...
                  <TableCell>
                    {e.features.clipboard ? <Badge>clipboard</Badge> : null}{" "}
                    {e.features.fileTransfer ? <Badge>file</Badge> : null}
                  </TableCell>
