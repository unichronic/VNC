...
export default function useInventory() {
  ...
  const add = useCallback((entry: Partial<InventoryEntry>) => {
  ...
  const update = useCallback((id: string, patch: Partial<InventoryEntry>) => {
  ...
  const testConnection = useCallback(async (id: string) => {
    ...
    const log = ok ? "TLS handshake ok; auth ok" : "Connection failed: timeout";
